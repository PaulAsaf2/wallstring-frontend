...
const audioFiles = {
  'A': document.getElementById("audioA"),
  'B': document.getElementById("audioB"),
  'C': document.getElementById("audioC"),
  'D': document.getElementById("audioD"),
  '9': document.getElementById("audio9"),
  '13': document.getElementById("audio13"),
  '45': document.getElementById("audio45"),
  '46': document.getElementById("audio46"),
  '20': document.getElementById("audio20"),
};
...
function playbackHandling() {
  ...
  playSound(letter)
    .then(() => setTimeout(() => playSound(number), 300))
